...
<body>
    <div class="container" data-version="3.0.3" data-metric-schema="standard-v1" data-sideout-home="${sideoutHome}" data-sideout-away="${sideoutAway}" data-breakpoint-home="${breakpointHome}" data-breakpoint-away="${breakpointAway}" data-service-home="${serviceEfficiencyHome}" data-service-away="${serviceEfficiencyAway}">
        ...
        <div class="footer">VoleyInsight v3.0.3 · Correcciones oficiales de marcador · Informe generado ${fechaHora}</div>
    </div>
    <script>
