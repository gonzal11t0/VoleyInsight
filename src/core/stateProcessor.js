...
class StateProcessor {
  ...
  hasChanged(currentState) {
    return !this.lastState || this.lastState.homeScore !== currentState.homeScore ||
  ...
  updateRuns(scorer) {
    if (scorer === 'home') { this.homeRun++; this.awayRun = 0; }
    else if (scorer === 'away') { this.awayRun++; this.homeRun = 0; }
  }
